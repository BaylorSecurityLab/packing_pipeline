"""
Yoda's Protector v1.0 GUI Automation Wrapper

v1.0 has a different UI from v1.01.x/v1.02 and v1.03.x lines.
"""
...
class YodaProtectorV10(BaseGUI):
    """
    Wrapper for Yoda's Protector v1.0 GUI automation.
    """
    ...
    def run(self, click_mode="all", file_path=None, output_dir=None):
        """
        Main execution flow for Yoda's Protector v1.0.
        ...
        try:
            print("\n" + "=" * 60)
            print("YODA'S PROTECTOR (yoda_protector_v1.0) GUI AUTOMATION")
            print("=" * 60)
            ...
            # Step 2: Launch application via cmd start
            ...
            time.sleep(0.5)
            self.click_at_percent(0.85, 0.38, "Browse button")
            ...
            # Step 8: Click the Protect button
            time.sleep(0.5)
            self.click_at_percent(0.2, 0.8, "Protect button")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Yoda's Protector v1.0 GUI Automation Wrapper",
    ...
    wrapper = YodaProtectorV10(yaml_path, main_dir)
