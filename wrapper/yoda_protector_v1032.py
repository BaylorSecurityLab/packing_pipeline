"""
Yoda's Protector v1.03.2 GUI Automation Wrapper
"""
...
class YodaProtectorV1032(YodaProtectorV103Base):
    """
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Yoda's Protector v1.03.2 GUI Automation Wrapper",
    ...
    wrapper = YodaProtectorV1032(yaml_path, main_dir)
