...
class ObsidiumV1880GUI(BaseGUI):
        ...
        while time.time() - start < 10:
            ...
            for hwnd, title in owned:
                ...
                if ok_hwnd:
                    ...
                    dlg_w = rect[2] - rect[0]
                    dlg_h = rect[3] - rect[1]
                    # OK button is roughly at 30% x, 85% y from the screenshot
    ...
    def run(self, click_mode="all", file_path=None, output_dir=None) -> bool:
        ...
        try:
            ...
            # Click SETTINGS menu on the left sidebar (before Protect)
            time.sleep(0.5)
            ...
            # Type the full path directly into the folder name field at the bottom
            # and press Enter — this works on both old and new style folder dialogs
            ...
            # Now find the dialog window and click Select Folder via win32gui
            folder_hwnd = None
            ...
            if folder_hwnd:
                # Look for any Button child that says "Select Folder" or "OK"
                button_hwnd = None
