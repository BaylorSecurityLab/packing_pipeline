"""
Obsidium v1.8.8 GUI Wrapper - STUB (Step 1: Launch and hold open)

Obsidium v1.8.8 is GUI-only. This wrapper will eventually:
  1. Launch Obsidium.exe
...
class ObsidiumV1880GUI(BaseGUI):
    ...
    def run(self, click_mode="all", file_path=None, output_dir=None) -> bool:
        print("\n" + "=" * 60)
        print("OBSIDIUM v1.8.8 WRAPPER - Launch / Hold / Close (STUB)")
        print("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Obsidium v1.8.8 GUI Wrapper (stub)"
    )
